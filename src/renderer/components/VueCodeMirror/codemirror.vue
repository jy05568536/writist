<template>
    <div class="vue-codemirror" :class="{ merge }" :style="{'height':height+'px'}">
...
<script>
  ...
  export default {
    ...
    computed: {
      height: {
        get () {
          if (this.value != null && this.value !== '' && this.codemirror) return this.codemirror.getScrollInfo().height + 400
          return 300
        }
      }
    },
